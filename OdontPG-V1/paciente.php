...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		...
		<div class="row-fluid">
		 <form method="post" action="" >
                           ...
                           <INPUT TYPE="text" NAME="apellidos" SIZE=48 MAXLENGTH=48>Edad: 
                           <INPUT TYPE="text" NAME="edad" SIZE=8 MAXLENGTH=8></TD>
                           <TR>
                           <TD>Documento:</TD>
                           <TD> <INPUT TYPE="text" NAME="doc" SIZE=8 MAXLENGTH=8>Tipo.Doc: 
                           <SELECT NAME="OPCION">
                           <OPTION>OPCION 1
                           <OPTION>OPCION 2
                           <OPTION>OPCION 3
                           ...
                           <TR>
                           <TD>Telefono:</TD>
                           <TD> <INPUT TYPE="text" NAME="telefono" SIZE=48 MAXLENGTH=48>  Eps: 
                           <INPUT TYPE="text" NAME="eps" SIZE=8 MAXLENGTH=8></TD>

                           <TR>
                           <TD>Direccion:</TD>
                           <TD> <INPUT TYPE="text" NAME="direccion" SIZE=5 MAXLENGTH=5>Ciudad:
    ...
    <?php
		if(isset($_POST['pac'])){
	        ...
	        $conexion->query("INSERT INTO $tabla_db1 (Pac_Codigo,Pac_Identificacion,Pac_Nombre,Pac_Apellido,Pac_telefono)
